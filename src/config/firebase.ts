...
const firebaseConfig = {
  ...
  // Fallback to .appspot.com if env var uses .firebasestorage.app
  storageBucket: process.env.REACT_APP_FIREBASE_STORAGE_BUCKET?.replace('.firebasestorage.app', '.appspot.com') || 'voltfox-b1cef.appspot.com',
